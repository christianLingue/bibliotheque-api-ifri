...
exports.EpreuveService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const epreuve_dto_1 = require("./epreuve.dto");
let EpreuveService = class EpreuveService {
    constructor(model) {
        this.model = model;
    }
    async create(epreuve) {
        try {
            console.log("contatctde service");
            return new this.model(Object.assign({}, epreuve)).save();
        }
        catch (error) {
    ...
    async findAll(query) {
        try {
            return await this.model.find(Object.assign(Object.assign({}, query), { isArchived: false })).populate('matiere');
        }
        catch (error) {
            throw new common_1.HttpException({ statusCode: common_1.HttpStatus.BAD_REQUEST, message: error.message }, common_1.HttpStatus.BAD_REQUEST);
        }
...
EpreuveService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(epreuve_dto_1.Epreuve.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], EpreuveService);
exports.EpreuveService = EpreuveService;
